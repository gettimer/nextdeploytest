...
export default function VersionGuncellemeIslemi() {
    ...
    function send() {
        setProcess(true);
        fetch('/api/contact?method=VersionUpdate&data=' + JSON.stringify(queryData)).then(res => res.json()).then(data => {
            setProcess(false);
    ...
    return (
        <Layout>
            <Head>
                <title>Terapi Yazılım - Versiyon Güncelleme İşlemi</title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <div className={styles.subpage_header}>
                <div className={styles.header_content}>
                    <h1>Versiyon Güncelleme İşlemi</h1>
                    <div className={styles.breadcrumb}>
                        <Link href='/'><a>anasayfa</a></Link>
                        <Link href=''><a>versiyon güncelleme işlemi</a></Link>
                    </div>
                </div>
            ...
            <div className={styles.subpage_horizontal_nav}>
                <div className='container'>
                    <div className={styles.subpage_nav_container}>
                        ...
                        <Link href=''><a className={styles.active}>Versiyon Güncelleme İşlemi</a></Link>
                    </div>
                </div>
            </div>
                    ...
                    <div className={styles.form_layout}>
                        <div className={styles.form_content}>
                            <div className={`${styles.contact_title} ${styles.contact_title_p0}`}>
                                <h3>Versiyon Güncelleme İşlemi</h3>
                            </div>
