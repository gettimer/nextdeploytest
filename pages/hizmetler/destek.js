                    ...
                    <div className={styles.split_layout}>
                        ...
                        <div className={styles.vert_nav}>
                            <ul>
                                ...
                                <li>
                                    <Link href='/hizmetler/destek'><a className={styles.active}>Destek</a></Link>
                                </li>
                                <li>
                        ...
                        <div className={styles.product_content}>
                            ...
                            <div>
                                <p>Siz de ürünlerinizle ilgili teknik destek almak için 0(224) 271 75 80 numaralı Teknik Destek Hattımızı arayabilirsiniz.
                        </p>
